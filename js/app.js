    ...
    (() => {
                ...
                function showMoreActions(e) {
                    ...
                    if (targetType === "click") {
                        if (targetEvent.closest("[data-showmore-button]")) {
                            ...
                            const showMoreSpeed = showMoreBlock.dataset.showmoreButton ? showMoreBlock.dataset.showmoreButton : "900";
                            const hiddenHeight = getHeight(showMoreBlock, showMoreContent);
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                ...
                if (window.innerWidth < 1e3) new swiper_core_Swiper(".countries__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                ...
                new swiper_core_Swiper(".featured-vendor__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                ...
                new swiper_core_Swiper(".vendor__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: "auto",
                ...
                new swiper_core_Swiper(".real-reviews__slider", {
                    modules: [ Navigation ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (uploadButtonPopup) uploadButtonPopup.addEventListener("click", (function() {
            ...
            if (uploadButtonPC) uploadButtonPC.addEventListener("click", (function() {
            ...
            if (submitButtonPC) submitButtonPC.addEventListener("click", (function(event) {
            ...
            if (checkboxPopup) checkboxPopup.addEventListener("click", (() => {
